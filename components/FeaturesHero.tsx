  ...
  return (
    <section ref={ref} className="pt-[72px] md:pt-20 px-4 md:px-6 pb-6">
      <div className="rounded-2xl relative overflow-hidden">
        ...
        {/* Text content */}
        <div className="relative z-10 max-w-[1280px] mx-auto px-4 md:px-8 pt-10 md:pt-16 pb-10 md:pb-12">
          <div className="max-w-[768px] flex flex-col gap-5">
            <p className="fh-label text-base font-semibold text-[#CECFD2]">Features</p>
            <h1
              className="fh-heading text-[36px] md:text-[48px] lg:text-[60px] font-bold leading-[44px] md:leading-[56px] lg:leading-[72px] tracking-[-0.02em]"
            ...
            >
              Built for the future<br className="hidden md:block" /> of sports production
            </h1>
