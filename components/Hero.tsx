        ...
        <div className="rounded-2xl relative overflow-hidden flex flex-col flex-1" style={{ background: '#2A2D3D' }}>
          ...
          <div className="relative z-10 flex-1 max-w-[1280px] w-full mx-auto px-6 md:px-8 pt-10 md:pt-16 pb-10 md:pb-16 flex flex-col">
            {expanded ? (
              ...
              /* ── Collapsed layout ── */
              <div className="flex flex-col md:justify-between md:flex-1">
                {/* Badge + heading */}
                <div className="max-w-[740px] flex flex-col gap-4 mb-6 md:mb-0 md:gap-12">
                  <div className="flex flex-col gap-4">
                ...
                {/* Mobile: description + single CTA above image */}
                <div className="h-ctas md:hidden flex flex-col gap-4 mb-6">
                  <p className="text-[17px] font-normal text-[#F7F7F7]/90 leading-[26px]">
                    From grassroots to elite — LIGR gives you AI-powered graphics,
                    automated overlays, and cloud streaming that make every game look like prime time.
                  </p>
                ...
                {/* Desktop bottom: supporting text + expandable video */}
                <div className="hidden md:flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12">
                  ...
                  <div
                    ref={videoRef}
                    className="h-video md:max-w-[400px] md:shrink-0 float group relative cursor-pointer"
